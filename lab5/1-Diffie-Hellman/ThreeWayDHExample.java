 ...
 * Thsi is an example on how to generalize a DH agreement
 * to more than 2 principals. We can have the same strategy to
 * generalize this to a group of N principals.
 */
public class ThreeWayDHExample {
	...
	public static void main(
		...
		System.out.println("A: I generated: " + UtilsDH.toHex(aShared));
		System.out.println("B: I generated: " + UtilsDH.toHex(bShared));
		System.out.println("C: I generated: " + UtilsDH.toHex(cShared));
	}
}
