 ...
 * Prime Number P, thwt will be used for the dynamic key-agreement
...
public class TwoWayDHExample {
	...
	public static void main(
		...
		System.out.println("A: I generated" + UtilsDH.toHex(aShared)); // printed by A
		System.out.println("B: I generated" + UtilsDH.toHex(bShared)); // printed by B
	}
}
