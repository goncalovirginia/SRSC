package _2Keytool_JCEKS_Keystores._2JCEKS_keystores;// Programatically using and managing keys in keystores ...
...
public class ManagingSKeysKeystores {
	public static void main(String[] args) {
		...
		try {
			...
			Key key1 = keyStore.getKey("aeskey", "hjhjhjhj".toCharArray());
			Key key2 = keyStore.getKey("3deskey", "hjhjhjhj".toCharArray());
