package _2Keytool_JCEKS_Keystores._1keygeneration;// A utilizacao da classe SecretKeySpec permite criar chaves
...
public class KeyGeneratorExample {
	public static void main(
		...
		System.out.println("Let's see what is in the Key Object ...");
		System.out.println("------------------------------------------------------");
