...
public class RSAKeyExchangeExample {
    ...
    public static void main(
        ...
        //SecureRandom     random = _1.1-UsingRSAandElGamal._1.2-UsingECC._1_1UsingRSAandElGamal._1_2UsingECC.Utils3.createFixedRandom();
        SecureRandom random = new SecureRandom();

        // Criacao de chaves _1.1-UsingRSAandElGamal._1_1UsingRSAandElGamal.RSA
        ...
        // IvParameterSpec sIvSpec = _1.1-UsingRSAandElGamal._1.2-UsingECC._1_1UsingRSAandElGamal._1_2UsingECC.Utils3.createCtrIvForAES(0, random);
        ...
        // symmetric key/iv wrapping com a cripto assimetrica _1.1-UsingRSAandElGamal._1_1UsingRSAandElGamal.RSA
        // Estamos a criar um envelope de chave publica, que permite
        // proteger a distribuicao da chave simetrica e IV

        Cipher xCipher = Cipher.getInstance("_1.1-UsingRSAandElGamal._1_1UsingRSAandElGamal.RSA/NONE/OAEPWithSHA1AndMGF1Padding", "BC");
